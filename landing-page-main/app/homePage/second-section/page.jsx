<<<<<<< HEAD:landing-page-main/app/homePage/second-section/page.tsx
"use client";
...
const features = [
    {
        name: "MoA Prediction Tool",
        description: "Unlock the future of drug discovery with our cutting-edge MoA prediction tool! Empower your research by accurately predicting a compound's Mechanism of Action from its cellular signature. Revolutionize the way you approach drug development and gain unprecedented insights into molecular pathways.",
        image: "/images/3d-fluency-sparkling.png",
        alt: "Customizable",
        color: "blue",
    },
    {
        name: " Insights and Analysis ",
        description: "Dive into a world of data-driven discoveries! Our platform not only predicts MoA but also provides in-depth insights and analysis. Uncover hidden patterns, identify novel connections, and stay at the forefront of scientific exploration. Elevate your research with our comprehensive analytical tools.",
        image: "/images/icon-analytics.png",
        alt: "Customizable",
    },
    {
        name: "Researches and Case Studies",
        description: "Explore the frontier of biotechnology with our curated collection of researches and case studies. Stay informed about the latest breakthroughs, success stories, and advancements in MoA. Gain a competitive edge by leveraging the knowledge and experiences shared by experts in the field. Your journey to innovation starts here.",
        image: "/images/icon-journey.png",
        alt: "Customizable",
    },
    {
        name: "Interactive Visualization",
        image: "/images/3d-fluency-accounting.png",
        description: "Immerse yourself in your data with our interactive visualization tools. Gain intuitive insights through dynamic charts and graphs that make complex data easy to understand. Explore your findings from multiple perspectives and communicate your discoveries effectively.",
        alt: "Customizable",
    },
    {
        name: "Enhanced Speed",
        description: "Accelerate your research with our high-performance platform. Experience rapid predictions and analyses to streamline your workflow and make informed decisions swiftly. Speed up your drug discovery process and stay ahead in the competitive landscape.",
        image: "/images/icon-fast.png",
        alt: "Customizable",
    },
    {
        name: " More..",
        description: "Stay tuned for more updates, and services that will redefine your journey with us. Your exploration has only just begun.",
        image: "/images/icon-layer.png",
        alt: "Customizable",
    },
];
const SecondSection = () => {
    return (<div className={styles.background}>
      <div className="
        ...
        <div className="md:ml-10 md:mt-0 mt-5">
          <Image className="rounded-xl" src="/images/first.jpg" width={600} height={600} alt="logo"/>
        </div>
      ...
      <div className="relative w-full h-full space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center p-8  md:p-12  max-w-7xl mx-auto">
        <img src="/images/kaggle.png" alt="Kaggle" width={600} height={400} className="rounded-xl object-cover w-full h-full"/>
                <div className="space-y-4">
          <h2 className="bg-gradient-to-r from-blue-800 to-yellow-500 bg-clip-text text-transparent text-4xl md:text-4xl font-bold pb-10">Problem Description</h2>
          <p className="text-xl mb-8 text-gray-700 dark:text-gray-200">
           In this competition, we had access to a unique dataset that combines gene expression and cell viability data. The data is based on a new technology that measures simultaneously (within the same samples) human cells’ responses to drugs in a pool of 100 different cell types (thus solving the problem of identifying ex-ante, which cell types are better suited for a given drug). In addition, you will have access to MoA annotations for more than 5,000 drugs in this dataset.
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl mb-8 text-gray-700 dark:text-gray-200">
           For detailed information about the competition, visit the Kaggle
              page:
              <a href="https://www.kaggle.com/c/lish-moa/overview" target="_blank">
                Kaggle - MOA Prediction Challenge
              </a>
          </p>
        </div>
  ...
  <div className="container mx-auto px-4 md:px-6">
    ...
    <div className="grid gap-4 md:gap-8 mt-6">
      ...
      <div className="flex-col items-center justify-center">
        ...
        <div className="grid grid-cols-1 p-4 md:grid-cols-3 gap-4 md:px-40">
          {features.map((feature, index) => (<div key={index} className="flex-col space-y-6 pb-10 border
                p-8 rounded-xl items-center justify-center w-full hover:scale-105 transform transition-all duration-500 ease-in-out
              ">
              <div className="
...
export default dynamic(() => Promise.resolve(SecondSection), { ssr: false });
>>>>>>> prediction_dashboard:landing-page-main/app/homePage/second-section/page.jsx
