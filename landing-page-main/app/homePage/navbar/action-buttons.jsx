<<<<<<< HEAD:landing-page-main/app/homePage/navbar/action-buttons.tsx
"use client";
      ...
      <div className="md:hidden">
        <Sheet>
          ...
          <SheetContent>
            <SheetHeader>
              <SheetDescription>
                <div className={`flex flex-col space-y-4 items-start w-full text-lg text-${textColor} mt-10`}>
                  <Link href="/">Home</Link>
...
export default ActionButtons;
>>>>>>> prediction_dashboard:landing-page-main/app/homePage/navbar/action-buttons.jsx
