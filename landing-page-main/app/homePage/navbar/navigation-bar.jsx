...
const components = [
    {
        title: "Frozen",
        description: "Recommended template for most use cases. Includes all the components you need to get started.",
    },
    {
        title: "Swift",
    ...
    {
        title: "Tuscany",
        description: "Advanced template with more components and features. Use this template if you want to build a complex UI.",
    },
    {
        title: "Amber",
        ...
        <NavigationMenuList className="hidden md:flex md:space-x-4">
          ...
          <NavigationMenuItem>
            <Link href="../../comp/data" legacyBehavior passHref>
              <NavigationMenuLink className=" font-medium  ml-7">
                Insights
              </NavigationMenuLink>
            </Link>
          </NavigationMenuItem>
